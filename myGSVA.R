...
#@supercell_no: create super cell to reduce computing resources, 
#for examples,50 means merge 50 cells into one merged super cell
#example as belows:
##**example 1**##
##gspath="/Users/jalon/Desktop/newest scripts/database/gsea/B_cell_related1.gmt"
##pheatmap_score=GSVA_cluster_diff(seurat_object = Breg.cut,gspath = gspath,species = "mouse",
##                                 supercell_no = 50,topn = 10)
library(GSVA)
library(GSEABase)
library(pheatmap)
library(limma)
...
GSVA_cluster_diff=function(seurat_object=NULL,method="ssgsea",
                           gspath="/Users/jalon/Desktop/newest scripts/database/gsea/h.all.v7.1.symbols.gmt",
